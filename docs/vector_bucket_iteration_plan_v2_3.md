...
> 当前实现注记：
> - 对外协议已收敛为 AWS S3 Vectors 风格动作 API：`CreateVectorBucket / CreateIndex / PutVectors / QueryVectors / DeleteVectors`
> - 当前部署形态使用 JuiceFS S3 gateway 作为 Milvus object storage，而不是早期草案中的 JuiceFS 挂载目录直连
> - Phase 2 的索引模型不通过公开 API 字段暴露，而是由服务端配置文件 `configs/vectorbucket.json` 中的 `bucketIndexPolicies` 决定 bucket 默认索引模型
...
![Phase 1 架构图](../milvus/docs/figs/vector_bucket_v2_3_system_overview.svg)

![Phase 1 Insert 流程图](../milvus/docs/figs/vector_bucket_v2_3_insert_flow.svg)

![Phase 1 Query 流程图](../milvus/docs/figs/vector_bucket_v2_3_query_flow.svg)
...
![Phase 2 架构图](../milvus/docs/figs/vector_bucket_v2_3_phase3.svg)

![Phase 2 Insert 流程图](../milvus/docs/figs/vector_bucket_v2_3_phase3_insert.svg)

![Phase 2 Query 流程图](../milvus/docs/figs/vector_bucket_v2_3_phase3_query.svg)
...
if pinned_sum + est_hnsw_mem > performance_budget:
    return 429 "pinned index budget exhausted"
```
...
![Phase 3 架构图](../milvus/docs/figs/vector_bucket_v2_3_tier_switch_arch.svg)

![Phase 3 Insert 流程图](../milvus/docs/figs/vector_bucket_v2_3_tier_switch_insert.svg)

![Phase 3 Query 流程图](../milvus/docs/figs/vector_bucket_v2_3_tier_switch_query.svg)
...
![Phase 4 架构图](../milvus/docs/figs/vector_bucket_v2_3_phase4_arch.svg)

![Phase 4 Insert 流程图](../milvus/docs/figs/vector_bucket_v2_3_phase4_insert.svg)

![Phase 4 Query 流程图](../milvus/docs/figs/vector_bucket_v2_3_phase4_query.svg)
